/*
  Progetto 2: Il Buzzer Passivo SuperMario con Arduino
...
// Array contenente la melodia di Super Mario  
...
// Array contenente le pause associate alla melodia di Super Mario 
int timeSuperMario[] = {
  12, 12, 12, 12,
  12, 12, 12, 12,
  12, 12, 12, 12,
...
void loop()
{
    ...
    int sizeMelody          = sizeof(melodySuperMario)/sizeof(int);
